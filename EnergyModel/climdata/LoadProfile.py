...
class LoadProfile():
    ...
    def copy_load_profile(self, load_profile_to_copy):
        ...
        self.closest_climate_city = load_profile_to_copy.closest_climate_city
        self.climate_zone = load_profile_to_copy.climate_zone
    ...
    def calculate_load_profile(self, hourly_data):
