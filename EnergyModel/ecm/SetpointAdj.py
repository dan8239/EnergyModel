...
class SetpointAdj(Ecm.Ecm):
    ...
    def apply_ecm(self, asset):
        if (isinstance(asset, Rtu.Rtu)):
            ...
            new_clg_swing_temp = asset.climate_data.clg_swing_temp + clg_delta_t
            new_htg_swing_temp = asset.climate_data.htg_swing_temp + htg_delta_t

            # get new clg design factor based on new swing temperatures
            clg_design_adj_fact = (asset.climate_data.clg_design_temp - new_clg_swing_temp) / (asset.climate_data.clg_design_temp - asset.climate_data.clg_swing_temp)
            ...
            htg_design_adj_fact = (asset.climate_data.htg_design_temp - new_htg_swing_temp) / (asset.climate_data.htg_design_temp - asset.climate_data.htg_swing_temp)
            ...
            asset.update_climate_data(new_htg_swing_temp, new_clg_swing_temp)
